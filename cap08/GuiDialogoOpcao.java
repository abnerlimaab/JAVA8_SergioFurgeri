...
public class GuiDialogoOpcao extends JPanel {
    ...
    private void definirEventos() {
        btAbrir.addActionListener((ActionEvent e) -> {
            String[] escolha = {"Masculino", "Feminino"};
            int resp = JOptionPane.showOptionDialog(null, "Escolha o sexo", "Sexo", 0, JOptionPane.INFORMATION_MESSAGE, new ImageIcon(getClass().getResource("/cap08/imagens/sexos.png")), escolha, escolha[0]);
