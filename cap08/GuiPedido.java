...
public class GuiPedido extends JPanel{
    ...
    private void inicializarComponentes() {
        ...
        btRemover.setToolTipText("Remove um item do pedido");
        ...
        tfTotal.setBounds(375, 370, 100, 25);
        ...
        pnTable.setBorder(new TitledBorder("Itens do Produto"));
        scrollTable = new JScrollPane();
        df.setMinimumFractionDigits(2);
        df.setMaximumFractionDigits(2);
        pnPrincipal.add(btAdicionar);
        pnPrincipal.add(btRemover);
        DefaultTableModel tableModel = new DefaultTableModel(new String[]{"Produto", "Qtde", "Preço Unit.", "Total"},0) {
    ...
    private void definirEventos() {
        btAdicionar.addActionListener((ActionEvent e) -> {
            ...
            dtm.addRow(new Object[] {tfProduto.getText(), tfQuantidade.getText(), tfPrecoUnitario.getText(), "" + df.format(Integer.parseInt(tfQuantidade.getText()) * Double.parseDouble(tfPrecoUnitario.getText()))});
            limparCampos();
            calcularTotal();
        });
