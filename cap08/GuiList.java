...
public class GuiList extends JPanel {
    ...
    private void definirEventos() {
        btCalcular.addActionListener((ActionEvent arg) -> {
            ...
            try {
                ...
                float desconto = 0.9f;
                if (liDesconto.getSelectedIndex() == 1) desconto = 0.8f;
                else if (liDesconto.getSelectedIndex() == 2) desconto = 0.7f;
                else if (liDesconto.getSelectedIndex() == 3) desconto = 0.6f;
                else if (liDesconto.getSelectedIndex() == 4) desconto = 0.5f;
