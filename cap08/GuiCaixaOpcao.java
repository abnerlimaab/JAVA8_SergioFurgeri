...
public class GuiCaixaOpcao extends JPanel {
    ...
    private void definirEventos() {
        btMarcar.addActionListener((ActionEvent arg0) -> {
            ckInformatica.setSelected(true);
            ckIngles.setSelected(true);});
        btDesmarcar.addActionListener((ActionEvent arg0) -> {
            ckInformatica.setSelected(false);
            ckIngles.setSelected(false);});
        btVerificar.addActionListener((ActionEvent arg0) -> {
            String selecao = "Selecionados: ";
            if (ckIngles.isSelected()) selecao += "\nInglês";
            if (ckInformatica.isSelected()) selecao += "\nInformática";
            if (!ckInformatica.isSelected() && !ckIngles.isSelected()) selecao += "\nNenhum item selecionado.";
